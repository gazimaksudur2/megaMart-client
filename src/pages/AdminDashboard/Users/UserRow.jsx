            ...
            <td class="px-4 py-4 text-sm whitespace-nowrap">
                <div className="dropdown dropdown-end">
                    ...
                    <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-44 p-2 shadow">
                        <li><a>
                            <button class="text-gray-500 transition-colors duration-200 hover:text-green-500 focus:outline-none flex items-center justify-center gap-3">
                                <TbUserEdit className='font-light' size={20} />
                                <h2>Make Admin</h2>
                            </button>
                        </a></li>
                        <li><a>
                            <button class="text-gray-500 transition-colors duration-200 hover:text-cyan-500 focus:outline-none flex items-center justify-center gap-3">
                        ...
                        <li><a>
                            <button class="text-gray-500 transition-colors duration-200 hover:text-amber-500 focus:outline-none flex items-center justify-center gap-3">
                                <RiErrorWarningLine className='font-light' size={20} />
                                <h2>Disable User</h2>
                            </button>
                        </a></li>
                        <li><a>
                            <button class="text-gray-500 transition-colors duration-200 hover:text-red-500 focus:outline-none flex items-center justify-center gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
